...
%token <ident> T_PRIVATE_SET    409  "'private(set)'"
%token <ident> T_PROTECTED_SET   410 "'protected(set)'"
%token <ident> T_PUBLIC_SET   411    "'public(set)'"
...
%token <ident> T_PROPERTY_C   412      "'__PROPERTY__'"
